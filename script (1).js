  ...
  // Once a photo is set, the uploader box hides itself.
  // ============================================================
  ...
  const avatarUploaderBox = document.querySelector('.avatar-uploader');
  ...
  function hideAvatarUploader() {
    if (avatarUploaderBox) avatarUploaderBox.style.display = 'none';
